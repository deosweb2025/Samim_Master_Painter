  ...
  return (
    <div className="fixed bottom-6 right-6 flex flex-col gap-4 z-50">
      ...
      <a
        ...
        className="bg-primary-600 hover:bg-primary-700 text-white p-4 rounded-full shadow-lg shadow-primary-600/30 transition-transform hover:scale-110 flex items-center justify-center"
        aria-label="Call"
      >
        <Phone size={28} />
      </a>
